...
class TestHandlers(unittest.TestCase):
    @patch("src.iot_modules.ipv4_scanner.IPv4Scanner.scan_range")
    ...
    @patch("src.iot_modules.authentication.Authenticator.telnet_open_scan")
    @patch.object(logger, "info", MagicMock())
    ...
    @patch("src.iot_modules.authentication.Authenticator.telnet_auth_scan")
    @patch.object(logger, "info", MagicMock())
    ...
    @patch("src.iot_modules.shodan_client.ShodanClient.get_device_info")
    @patch.object(logger, "info", MagicMock())
